...
import { Send, Search, User, HelpCircle } from "lucide-react";
...
export function ChatPanel({ projectId, onNavigateMember }: {
  ...
  async function handleSend(query?: string) {
    ...
    const userMsg: QueryMessage = { id: Date.now().toString(), role: 'user', content: text, timestamp: new Date().toISOString() };
